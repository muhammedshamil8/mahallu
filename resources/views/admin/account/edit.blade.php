...
@section('title', 'Noble Mahallu | Edit Accounts Head')
@section('css_scripts')
<!-- Font Awesome -->
            ...
            <div class="card-body">
              ...
              <div class="tab-content" id="custom-tabs-three-tabContent">
                <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                  ...
                  <form method="post" action="{{route('account_list.update',$account->id)}}">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="type">
                            ...
                            <option value="income" @if ($account->type == 'income') selected="selected" @endif>Income</option>
                            <option value="expense" @if ($account->type == 'expense') selected="selected" @endif>Expense</option>
                            <option value="both" @if ($account->type == 'both') selected="selected" @endif>Both</option>
                          </select>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="description" placeholder="Enter ...">{{ $account->description }}</textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-2">
