        ...
        <form method="post" action="{{ route('members.store') }}" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Father/Husband Name" name="father_name" value="{{ old('father_name') }}">
              </div>
            </div>
          </div>
          <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <select id="day" name="day" class="form-control" onchange="setDays(month,this,year)">
                      ...
                      @for ($i = $now; $i <= $last; $i++) <option value="{{ $i }}" @if (old('day')==$i) selected="selected" @endif>{{ $i }}</option>
                        @endfor
                    </select>
                  </div>
                  <div class="col-sm-4">
                    <select id="month" name="month" class="form-control" onchange="setDays(this,day,year)">
                      ...
                      @for ($i = 1; $i <= 12; $i++) <option value="{{ $i }}" @if (old('month')==$i) selected="selected" @endif>{{ $i }}</option>
                        @endfor
                    </select>
                  </div>
                  <div class="col-sm-4">
                    <select id="year" name="year" class="form-control" onchange="setDays(month,day,this)">
                      ...
                      @for ($i = $last; $i <= $now; $i++) <option value="{{ $i }}" @if (old('year')==$i) selected="selected" @endif>{{ $i }}</option>
                        @endfor
                    </select>
                  </div>
                </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="form-control" name="blood_group">
                  ...
                  @if (old('blood_group') == $blood_group->id)
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Voter ID" name="id_card_no" value="{{ old('id_card_no') }}">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label>ആധാർ </label>
                <input type="text" class="form-control" placeholder="Aadhar No" name="aadhar_card_no" value="{{ old('aadhar_card_no') }}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="select2" multiple="multiple" data-placeholder="Select a education" style="width: 100%;" name="education[]">
                  ...
                  @if (old('education'))
                  <option value="{{ $education->id }}" {{ in_array($education->id, old('education')) ? 'selected' : '' }}>{{ $education->name }}</option>
                  @else
                  <option value="{{ $education->id }}" {{ $education->id ==1 ? 'selected' : '' }}>{{ $education->name }}</option>
                  @endif
                  @endforeach
                </select>
              </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="select2" multiple="multiple" data-placeholder="Select a education" style="width: 100%;" name="islamic_education[]">
                  ...
                  @if (old('education'))
                  <option value="{{ $education->id }}" {{ in_array($education->id, old('islamic_education')) ? 'selected' : '' }}>{{ $education->name }}</option>
                  @else
                  <option value="{{ $education->id }}" {{ $education->id ==1 ? 'selected' : '' }}>{{ $education->name }}</option>
                  @endif
                  @endforeach
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="is_finding_job" value="is_finding_job" @if (old('is_finding_job')=='is_finding_job' ) checked="checked" @endif>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="is_looking_marriage" value="is_looking_marriage" @if (old('is_looking_marriage')=='is_looking_marriage' ) checked="checked" @endif>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="is_name_in_voter_list" value="is_name_in_voter_list" @if (old('is_name_in_voter_list')=='is_name_in_voter_list' ) checked="checked" @endif>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="select2" multiple="multiple" data-placeholder="Select a job" style="width: 100%;" name="job[]">
                  @foreach($jobs as $job)
                  @if (old('job'))
                  <option value="{{ $job->id }}" {{ in_array($job->id, old('job')) ? 'selected' : '' }}>{{ $job->name }}</option>
                  @else
                  <option value="{{ $job->id }}" {{ $job->id ==1 ? 'selected' : '' }}>{{ $job->name }}</option>
                  @endif
                  @endforeach
                </select>
              </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter ..." name="job_place" value="{{ old('job_place') }}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label>Income</label>
                <input type="text" class="form-control" placeholder="Enter ..." name="income" value="{{ old('income') }}">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="form-control" name="marital_status_id">
                  ...
                  @if (old('marital_status_id') == $marital_status->id)
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select class="form-control" name="physical_status_id">
                  ...
                  @if (old('physical_status_id') == $physical_status->id)
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter ..." name="number_of_child" value="{{ old('number_of_child') }}">
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Health infomation" name="health_info" value="{{ old('health_info') }}">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Government help information" name="gov_help_info" value="{{ old('gov_help_info') }}">
              </div>
            </div>
          </div>
          <div class="row">
