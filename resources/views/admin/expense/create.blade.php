...
@section('title', 'Noble Mahallu | Manage Expense')
@section('css_scripts')
<!-- Font Awesome -->
      ...
      <div class="container-fluid">
        <div class="col-12 col-sm-12">
          <div class="card card-primary card-outline card-tabs">
            ...
            <div class="card-body">
                  ...
                  <form method="post" action="{{route('expense.store')}}">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Voucher.No" name="receipt_number" value="{{ old('receipt_number') }}">
                        </div>
                      </div> 
                      <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input type="radio" id="staff" name="paid_to" value="staff" @if( old('paid_to') == 'staff' ) checked @endif>
                        <label for="staff" >Staff</label>
                        <input type="radio" id="shop" name="paid_to" value="shop" @if( old('paid_to') == 'shop' ) checked @endif>
                        <label for="shop" >Shop</label>
                        <input type="radio" id="other" name="paid_to" value="other" @if( old('paid_to') == 'other' ) checked @endif>
                      ...
                      <div class="col-sm-6" style="display: none;" id="other_div">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter name" name="paid_to_other" value="{{ old('paid_to_other') }}">
                        </div>
                      </div>
                    </div>
              <div class="row">
              ...
              <div class="col-sm-8" style="display: none;" id="check_div">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Bank Name" name="check_bank_name" value="{{ old('check_bank_name') }}">
                </div>
              </div>
            </div>
            ...
            <input type="hidden" id="paid_to_selected" value="{{ old('paid_to') }}">
