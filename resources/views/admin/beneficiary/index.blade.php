...
@section('title', 'Noble Mahallu | Beneficiary')
@section('css_scripts')
<!-- Font Awesome -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div>
                ...
                <a style="margin: 19px;" href="{{ route('beneficiaries.create')}}" class="btn btn-primary">New Beneficiary</a>
                @endcan
              </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('beneficiaries.edit',$beneficiary->id)}}" class="btn btn-primary">Edit</a>
                      @endcan
                    </td>
                    <td>
