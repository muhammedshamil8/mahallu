...
@section('title', 'Noble Mahallu | Add Beneficiary')
@section('css_scripts')
<!-- Font Awesome -->
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select class="select2" multiple="multiple" data-placeholder="Select helps" style="width: 100%;" name="helps[]">
                            ...
                            @if (old('helps'))
                            <option value="{{ $help->id }}" {{ in_array($help->id, old('helps')) ? 'selected' : '' }}>{{ $help->name }}</option>
                            @else
                            <option value="{{ $help->id }}" {{ $help->id ==1 ? 'selected' : '' }}>{{ $help->name }}</option>
                            @endif
                            @endforeach
