...
@section('title', 'Noble Mahallu | Create Institution')
@section('css_scripts')
<!-- Font Awesome -->
          ...
          <div class="card card-primary card-outline card-tabs">
            ...
            <div class="tab-content" id="custom-tabs-three-tabContent">
              <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                ...
                <form method="post" action="{{ route('families.update', $family->id) }}">@method('PATCH') 
                  @csrf
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>കുടുംബനാഥൻ<i class="fa fa-asterisk" style="color:red"></i></label>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>വരിസംഖ്യ നൽകുന്ന പള്ളികൾ <i class="fa fa-asterisk" style="color:red"></i></label>
                        <select class="select2" multiple="multiple" data-placeholder="Select Masjid" style="width: 100%;" name="favorite_masjid[]">
            ...
            <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
              <a style="margin: 19px;" href="{{ route('members.create',['id' => $family->id])}}" class="btn btn-primary"><i class="fa fa-plus"></i>Add Members</a>
