...
@section('title', 'Noble Mahallu | Create Committe')
@section('css_scripts')
<!-- Font Awesome -->
      ...
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <div class="card-body">
            ...
            @endif
            <form method="post" action="{{route('committee-members.update',$committee_member->id)}}">
              @method('PATCH')
              @csrf
              <div class="row">
                <div class="col-sm-12">
                 <input type="radio" id="member" name="member_type" value="member" @if( $committee_member->member_type == 'member' ) checked @endif>
                 <label for="member" >Member</label>
                 <input type="radio" id="non_member" name="member_type" value="non_member" @if( $committee_member->member_type == 'non_member' ) checked @endif>
                ...
                <div class="col-sm-4" style="display: block;" id="member_div">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="member">
                        ...
                        @if ($committee_member->member_id == $member->id)
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="designation">
                      ...
                      @if ($committee_member->designation_id == $designation->id)
              ...
              <input type="hidden" id="member_type_selected" value="{{$committee_member->member_type}}">
              <div class="col-sm-2">
