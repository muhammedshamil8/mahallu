...
@section('title', 'Noble Mahallu | Edit Income')
@section('css_scripts')
<!-- Font Awesome -->
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Receipt.No" name="receipt_number" value="{{ $income->receipt_number }}">
                        </div>
                      </div> 
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label >Date</label>
                          <div class="col-sm-12">
                            <input class="form-control" type="date" name="date"value="{{Carbon\Carbon::parse($income->date)->format('Y-m-d')}}" >
                          </div>
                        </div>
                      </div> 
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Amount" name="amount" value="{{ $income->amount }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input type="radio" id="member" name="received_from" value="member" @if($income->received_from == 'member' ) checked @endif>
                        <label for="member" >Member</label>
                        <input type="radio" id="donor" name="received_from" value="donor" @if($income->received_from == 'donor' ) checked @endif>
                        <label for="donor" >Donor</label>
                        <input type="radio" id="student" name="received_from" value="student" @if($income->received_from == 'student' ) checked @endif>
                        <label for="student" >Student</label>
                        <input type="radio" id="other" name="received_from" value="other" @if($income->received_from == 'other' ) checked @endif>
                      ...
                      <div class="col-sm-6" style="display: none;" id="student_div">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="student">
                            ...
                            @if ($income->student_id == $student->id)
                      ...
                      <div class="col-sm-6" style="display: none;" id="other_div">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter name" name="received_from_other" value="{{ $income->received_from_other }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="towards">
                            ...
                            @if ($income->towards_id == $account->id)
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="committee">
                            ...
                            @if ($income->committee_id == $committe->id)
              ...
              <div class="row">
                <div class="col-sm-4">
                 ...
                 <input type="radio" id="cashbtn" name="payment_mode" value="cashbtn" @if($income->payment_mode == 'cashbtn' ) checked @endif>
                 <label for="cashbtn" >Cash</label>

                 <input type="radio" id="bankbtn" name="payment_mode" value="bankbtn" @if($income->payment_mode == 'bankbtn' ) checked @endif>
                 <label for="bankbtn" >Bank</label>
                 <input type="radio" id="checkbtn" name="payment_mode" value="checkbtn" @if($income->payment_mode == 'checkbtn' ) checked @endif>
               ...
               <div class="col-sm-8" style="display: block;" id="receiver_div">
                <div class="form-group">
                  ...
                  <select class="form-control" name="receiver">
                    ...
                    @if ($income->receiver_id == $receiver->id)
              ...
              <div class="col-sm-8" style="display: none;" id="bank_div">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Transaction Number" name="transaction_number" value="{{ $income->transaction_number }}">
                </div>
              </div>
              <div class="col-sm-8" style="display: none;" id="check_div">
                <div class="form-group">
                  <label>Check Details<i class="fa fa-asterisk" style="color:red"></i></label>
                  <textarea class="form-control" name="check_details" placeholder="Enter check number ,date,bank">{{ $income->check_details }}</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="description" placeholder="Enter ...">{{ $income->description }}</textarea>
                </div>
              </div>
            </div>
            <input type="hidden" id="received_from_selected" value="{{$income->received_from}}">
            <input type="hidden" id="payment_mode_selected" value="{{$income->payment_mode}}">
            <div class="col-sm-2">
