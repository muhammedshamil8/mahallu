...
<section class="w3l-skill-breadcrum">
  <div class="breadcrum">
    <div class="container">
      <p><a href="{{route('student/dashboard')}}">Home</a> &nbsp; / &nbsp; Dashboard</p>
    </div>
  </div>
</section>
<!-- //breadcrum -->
    ...
    <div class="container py-lg-5">
      <div class="row cwp23-content align-items-center">
        ...
        <div class="col-lg-6 mt-lg-0 mt-5 cwp23-img">
          <img src="{{ asset('assets/images/g6.jpg')}}" class="img-fluid" alt="" />
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="owl-two owl-carousel owl-theme">
            <div class="item">
              <div class="card">
                <div class="card-header p-0 position-relative">
                  <a href="{{route('student/subjects')}}" class="zoom d-block">
                    <img class="card-img-bottom d-block" src="{{ asset('assets/images/g1.jpg')}}" alt="Card image cap">
                  </a>
                  <div class="author">
                    <div class="author-image">
                      <img src="{{ asset('assets/images/student2.jpg')}}" class="img-fluid rounded-circle" title="Adam Ster" alt="author image">
                    </div>
                    <div class="course-title">
                      <a href="{{route('student/subjects')}}">Course Title</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer course-price-view">
                  <ul class="blog-list">
                    <li>
                        <a href="{{route('student/subjects')}}"><span class="fa fa-heart"></span> 98</a>
                    </li>
                    <li>
              ...
              <div class="card">
                <div class="card-header p-0 position-relative">
                  <a href="#url" class="zoom d-block">
                    <img class="card-img-bottom d-block" src="{{ asset('assets/images/g2.jpg')}}" alt="Card image cap">
                  </a>
                  <div class="author">
                    <div class="author-image">
                      <img src="{{ asset('assets/images/student3.jpg')}}" class="img-fluid rounded-circle" title="Adam Ster" alt="author image">
                    </div>
                    <div class="course-title">
            ...
            <div class="item">
              <div class="card">
                <div class="card-header p-0 position-relative">
                  <a href="#url" class="zoom d-block">
                    <img class="card-img-bottom d-block" src="{{ asset('assets/images/g3.jpg')}}" alt="Card image cap">
                  </a>
                  <div class="author">
                    <div class="author-image">
                      <img src="{{ asset('assets/images/student4.jpg')}}" class="img-fluid rounded-circle" title="Adam Ster" alt="author image">
                    </div>
                    <div class="course-title">
                      <a href="#url">Course Title</a>
                    </div>
            ...
            <div class="item">
              <div class="card">
                <div class="card-header p-0 position-relative">
                  <a href="#url" class="zoom d-block">
                    <img class="card-img-bottom d-block" src="{{ asset('assets/images/g5.jpg')}}" alt="Card image cap">
                  </a>
                  <div class="author">
                    <div class="author-image">
                      <img src="{{ asset('assets/images/student1.jpg')}}" class="img-fluid rounded-circle" title="Adam Ster" alt="author image">
                    </div>
                    <div class="course-title">
                      <a href="#url">Course Title</a>
                    </div>
    ...
    <div class="container py-lg-5">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6 mt-5">
          <div class="box16">
            <a href="#url"><img src="{{ asset('assets/images/student1.jpg')}}" alt="" class="img-fluid" /></a>
        ...
        <div class="col-lg-4 col-sm-6 mt-5">
          <div class="box16">
            <a href="#url"><img src="{{ asset('assets/images/student2.jpg')}}" alt="" class="img-fluid" /></a>
            <div class="box-content">
        ...
        <div class="col-lg-4 col-sm-6 mt-5">
          <div class="box16">
            <a href="#url"><img src="{{ asset('assets/images/student3.jpg')}}" alt="" class="img-fluid" /></a>
            <div class="box-content">
        ...
        <div class="col-lg-4 col-sm-6 mt-5">
          <div class="box16">
            <a href="#url"><img src="{{ asset('assets/images/student4.jpg')}}" alt="" class="img-fluid" /></a>
            <div class="box-content">
              <h3 class="title"><a href="#url">George</a></h3>
              <span class="post">Designer</a></span>
              <ul class="social">
